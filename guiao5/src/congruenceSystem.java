...
public class congruenceSystem {
  ...
  public static void main(String[] args){
    Equation eq1 = new Equation(Integer.parseInt(args[0]),Integer.parseInt(args[1]),Integer.parseInt(args[2]));  
    Equation eq2 = new Equation(Integer.parseInt(args[3]),Integer.parseInt(args[4]),Integer.parseInt(args[5]));
    Equation eq3 = new Equation(Integer.parseInt(args[6]),Integer.parseInt(args[7]),Integer.parseInt(args[8]));
